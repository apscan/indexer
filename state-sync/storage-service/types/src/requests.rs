...
pub struct StorageServiceRequest {
    ...
    pub use_compression: bool,     // Whether or not to use data compression in the response
}
...
/// A storage service data request
#[derive(Clone, Debug, Deserialize, Eq, Hash, PartialEq, Serialize)]
...
impl DataRequest {
    /// Returns a summary label for the data request
