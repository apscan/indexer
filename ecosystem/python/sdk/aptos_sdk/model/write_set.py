...
class WriteSet(
    ...
    def _discriminator(cls):
        return {
            'type': {
                'WriteSet_DirectWriteSet': WriteSetDirectWriteSet,
                'WriteSet_ScriptWriteSet': WriteSetScriptWriteSet,
                'direct_write_set': WriteSetDirectWriteSet,
                'script_write_set': WriteSetScriptWriteSet,
            }
        }
