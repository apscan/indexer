...
class TransactionPayload(
    ...
    def _discriminator(cls):
        return {
            'type': {
                'TransactionPayload_ModuleBundlePayload': TransactionPayloadModuleBundlePayload,
                'TransactionPayload_ScriptFunctionPayload': TransactionPayloadScriptFunctionPayload,
                'TransactionPayload_ScriptPayload': TransactionPayloadScriptPayload,
                'TransactionPayload_WriteSetPayload': TransactionPayloadWriteSetPayload,
                'module_bundle_payload': TransactionPayloadModuleBundlePayload,
                'script_function_payload': TransactionPayloadScriptFunctionPayload,
                'script_payload': TransactionPayloadScriptPayload,
                'write_set_payload': TransactionPayloadWriteSetPayload,
            }
        }
