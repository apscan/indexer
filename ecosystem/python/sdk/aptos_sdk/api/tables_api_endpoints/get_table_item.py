...
RequestOptionalQueryParams = typing.TypedDict(
    ...
    {
        'ledger_version': LedgerVersionSchema,
    },
    total=False
)
...
request_path_table_handle = api_client.PathParameter(
    name="table_handle",
    style=api_client.ParameterStyle.SIMPLE,
    schema=TableHandleSchema,
    required=True,
)
# body param
SchemaForRequestBodyApplicationJson = TableItemRequest


request_body_table_item_request = api_client.RequestBody(
    content={
...
_path = '/tables/{table_handle}/item'
_method = 'POST'
...
SchemaFor200ResponseBodyApplicationJson = MoveValue
...
class GetTableItem(api_client.Api):
    ...
    def get_table_item(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_table_item_request.serialize(body, content_type)
