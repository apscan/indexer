...
_path = '/accounts/{address}/module/{module_name}'
_method = 'GET'
...
SchemaFor200ResponseBodyApplicationJson = MoveModuleBytecode
...
class GetAccountModule(api_client.Api):
