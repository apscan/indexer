...
# path params
AddressSchema = StrSchema
ResourceTypeSchema = MoveStructTagParam
...
_path = '/accounts/{address}/resource/{resource_type}'
_method = 'GET'
...
SchemaFor200ResponseBodyApplicationJson = MoveResource
...
class GetAccountResource(api_client.Api):
