...
EventHandleSchema = MoveStructTagParam
FieldNameSchema = StrSchema
...
_path = '/accounts/{address}/events/{event_handle}/{field_name}'
_method = 'GET'
...
class GetEventsByEventHandle(api_client.Api):
