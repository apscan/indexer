...
request_path_event_key = api_client.PathParameter(
    name="event_key",
    style=api_client.ParameterStyle.SIMPLE,
    schema=EventKeySchema,
    required=True,
)
_path = '/events/{event_key}'
_method = 'GET'
...
class GetEventsByEventKey(api_client.Api):

    def get_events_by_event_key(
        self: api_client.Api,
